    ...
    <div>
      ...
      >
        <h1 id="details" className="text-2xl font-bold" data-aos="fade-up">
          More about External Wall Insulation
        </h1>
        <p id="" className="text-gray-600" style={{ fontFamily: "Barlow" }} data-aos="fade-up" data-aos-delay="100">
          The role of external wall insulation is to increase the thermal
          efficiency of houses built with solid walls. However, installing it is
          not always straightforward. Our expert guide explains everything to
          consider before installation. External wall insulation refers to a
          layer of insulation that's fixed to the outside of an existing wall.
          This layer will be finished either with a coat of render or with an
          alternative cladding material to protect it from the elements.
          <br />
          <br />
          This is a common method of insulating walls used by those with solid
          walls, where cavity wall insulation is impossible. That said there are
          some other situations where external wall insulation make sense.{" "}
        </p>
        <hr />
        <img
        ...
        <Paragarh text="External wall insulation involves adding a layer of insulation to the outside of a building's walls, often covered with render or cladding to protect against weather." data-aos="fade-up" data-aos-delay="100" />

        <Paragarh text="This is a common method of insulating walls used by those with solid walls, where cavity wall insulation is impossible. That said there are some other situations where external wall insulation make sense.

Upgrading and adding insulation should be something anyone who wants to improve the thermal efficiency of their home should consider, but it still pays to be aware that no form of wall insulation is without some form of challenge — often centred around how your home deals with moisture." data-aos="fade-up" data-aos-delay="200" />
        ...
        <p className="pb-4" data-aos="fade-up" data-aos-delay="100">
          <ul className="list-disc list-inside">
            <li className="text-black font-semibold ml-6 mb-2">Improves thermal efficiency and reduces energy bills.</li>
            <li className="text-black font-semibold ml-6 mb-2">Enhances sound resistance and reduces condensation.</li>
            <li className="text-black font-semibold ml-6 mb-2">Allows walls to contribute to thermal mass without loss of internal space.</li>
            <li className="text-black font-semibold ml-6 mb-2">Gives homes a fresh appearance and improves durability.</li>
          </ul>
        </p>

        <hr className="border-gray-300 mb-10 "  />

        <h1 className="text-2xl  border-gray-300  font-bold pt-6" data-aos="fade-up">Will external wall insulation cause damp in my home?</h1>
        ...
        <img src="/images/PnpUHNe8txt5nea57EPtLW-970-80.jpg.webp" alt="" className="w-[100%] h-[60%] rounded-lg mx-auto" data-aos="zoom-in" data-aos-delay="200" />
        <p className="text-gray-600  pt-4" style={{ fontFamily: "Barlow" }} data-aos="fade-up" data-aos-delay="300">
        ...
        <p className="text-gray-600" style={{ fontFamily: "Barlow" }} data-aos="fade-up" data-aos-delay="100">
          Yes, you can add external wall insulation to solid stone walls. However, it is important to ensure that the insulation is installed correctly to avoid any potential issues with dampness or condensation.
        </p>
        ...
        <hr className="border-gray-300 mb-10 "  />
        <img src="/images/bxbXuk7drPhhpe6zeTwMaB-970-80.jpg.webp" alt="" className="w-[100%] h-[60%] rounded-lg mx-auto" data-aos="zoom-in" data-aos-delay="200" />
        <p className="text-gray-600" style={{ fontFamily: "Barlow" }} data-aos="fade-up" data-aos-delay="300">
...
export default ExternalWallInsulation;
