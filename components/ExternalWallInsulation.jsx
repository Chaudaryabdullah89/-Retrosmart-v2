...
const ExternalWallInsulation = () => {
 ...
 <hr className="border-gray-300 mt-10 "  />
        ...
        <h1 className="text-2xl  border-gray-300  font-bold pt-6">
          ...
          <Paragarh text="External wall insulation involves adding a layer of insulation to the outside of a building’s walls, often covered with render or cladding to protect against weather.
...
<h1 className="text-2xl  border-gray-300  font-bold pt-6">Will external wall insulation cause damp in my home?</h1>
...
<h1 className="text-2xl  border-gray-300  font-bold pt-6">
Is planning permission required to add external wall insulation?</h1>
