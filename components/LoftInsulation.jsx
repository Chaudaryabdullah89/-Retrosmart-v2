  ...
  return (
    <div>
      ...
      >
        ...
        <hr />
        <div className="w-full h-[400px] rounded-lg mx-auto" data-aos="zoom-in" data-aos-delay="200">
        ...
        <Paragarh text="Loft insulation involves adding a layer of insulating material to the floor of your loft space. This creates a thermal barrier that prevents heat from escaping through the roof, keeping your home warmer in winter and reducing your heating bills." data-aos="fade-up" data-aos-delay="100" />

        <Paragarh text="The most common types of loft insulation include mineral wool, sheep's wool, and rigid insulation boards. The choice of material depends on various factors including your budget, the type of loft space, and whether you plan to use the loft for storage." data-aos="fade-up" data-aos-delay="200" />
        ...
        <img src="/images/loft-insulation-buying-guide-v2.jpg" alt="Types of Loft Insulation" className="w-[100%] h-[60%] rounded-lg mx-auto" data-aos="zoom-in" data-aos-delay="200" />
